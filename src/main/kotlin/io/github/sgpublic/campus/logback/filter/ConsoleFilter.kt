package io.github.sgpublic.campus.logback.filter

import ch.qos.logback.classic.Level
import ch.qos.logback.classic.spi.ILoggingEvent
import ch.qos.logback.core.filter.AbstractMatcherFilter
import ch.qos.logback.core.spi.FilterReply
import io.github.sgpublic.campus.Application
...
open class ConsoleFilter: AbstractMatcherFilter<ILoggingEvent>() {
    companion object {
        ...
        @JvmStatic
        private val product = Level.INFO
    }
    ...
    override fun decide(event: ILoggingEvent): FilterReply {
        ...
        return if (event.loggerName.startsWith("io.github.sgpublic")){
            filterOnSelf(event)
        } else {
            filterOnOther(event)
        }
